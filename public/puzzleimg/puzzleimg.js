...
function PuzzleImg(id_p, im, cols, rows, wg, hg){
  ...
  function setElms(id_p, im){
    ...
    parent.innerHTML ='<canvas id="'+ id_p +'_cnv" width="'+ width +'" height="'+ height +'" class="puzcnv"></canvas><span>The puzzle involves reordering squares to reconstruct the photo. Swap squares by clicking on a given square and then the one you want to swap it with.</span>';
